...
# What is AAPL?
class(AAPL) #xts and zoo are time series objects that allow irregularities like day offs for stock markets; xts is used when time series is not in sequence
head(AAPL)
tail(AAPL)
